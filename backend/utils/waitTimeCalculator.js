 ...
 * @param {Date} [dateTime] 
 */
function calculateWaitTime(onlineBookingsRemaining, offlineWalkIns, dateTime = new Date()) {
  ...
  else timeOfDayMultiplier = 0.6; // 22:00-05:59

  const day = dateTime.getDay();
  let dayMultiplier = 1.0;

  if (day === 1) dayMultiplier = 1.4; // Monday
  else if (day === 5) dayMultiplier = 1.2; // Friday
  else if (day === 6) dayMultiplier = 0.9; // Saturday
  else if (day === 0) dayMultiplier = 0.7; // Sunday
